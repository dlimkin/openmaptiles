...
RETURNS hstore AS $$
    SELECT delete_empty_keys(slice(tags, ARRAY['name:en', 'name:ru', 'name:uk', 'int_name', 'loc_name', 'name', 'wikidata', 'wikipedia', 'old_name','old_name:en','old_name:ru','old_name:uk']))
